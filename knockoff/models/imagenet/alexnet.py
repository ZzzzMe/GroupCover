...
class AlexNet(nn.Module):
    ...
    def __init__(self, num_classes=10, img_size=64, restore_params = None):
        super(AlexNet, self).__init__()
        if restore_params!=None:
            self.features = nn.Sequential(
                mod_conv(3, 64, restore_params = restore_params[0] ,name = "conv1",kernel_size=11, stride=4, padding=5),
